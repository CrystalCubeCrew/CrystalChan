...
public class TakePicture : MonoBehaviour
{
    ...
    private const string GOOGLE_API_KEY = "AIzaSyCgaeXLCxpBYgWiH6APQ02tjBKGkB2At_E";
    //enter your cloud name from cloudinary here
    private const string CLOUD_NAME = "crystalcube";
    //enter your cloudinary upload preset name
    private const string UPLOAD_PRESET_NAME = "goam8o71";
